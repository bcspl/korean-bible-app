...
Phase 3: ░░░░░░░░░░   0% ⏳ (북마크/설정 + 찬송가/신경/기도/교독문/About - 당장 다음)
Phase 4: ░░░░░░░░░░   0% ⏳ (고도화)
Phase 5: ░░░░░░░░░░   0% ⏳ (배포)
```

**당장 다음 할 일 (상세, <1주 단위, 전체 대비)**:
1. Phase 3 Day1~2: Bookmark model + Hive + viewer 버튼 + 목록 구현 (북마크 기능)
2. Phase 3 Day2~3: 설정 화면 + 본문 검색 결과 polish (글꼴 크기/다크모드 토글)
3. 찬송가 가사+악보, 사도신경, 주기도문, 교독문 화면 + "이 성경앱에 대해서" 페이지 구현 (메모 기능 완전 삭제)
