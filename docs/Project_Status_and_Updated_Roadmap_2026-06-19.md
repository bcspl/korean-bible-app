...
- **당장 다음 (상세)**: Phase 3 북마크 → 하이라이트 → 검색 polish (자세한 태스크는 백로그 참조)
- **남은**: Phase 3-5 전체 (사용자 기능, 고도화, 배포)
...
### 진행률 시각화
```
전체 로드맵 (Phase 0-5): [████████░░░░░░░░░░░░░░░░░░░░] ~40% 완료
Phase 0: ██████████ 100% ✅ (기반)
Phase 1: ██████████ 100% ✅ (데이터 계층: 모델+어댑터+JSON 로더)
Phase 2: ██████████ 100% ✅ (기본 읽기 UI + 검색 + 홈 + 디자인)
Phase 3: ░░░░░░░░░░   0% ⏳ (북마크/하이라이트/설정 - 당장 다음)
Phase 4: ░░░░░░░░░░   0% ⏳ (고도화)
Phase 5: ░░░░░░░░░░   0% ⏳ (배포)
```

**당장 다음 할 일 (상세, <1주 단위, 전체 대비)**:
1. Phase 3 Day1~2: Bookmark model + Hive + viewer 버튼 + 목록 (북마크 기능)
2. Phase 3 Day2~3: Highlight + note per verse (텍스트 선택 + 저장)
3. Phase 3 Day3~5: 본문 검색 결과 polish + 하이라이트 + 설정 화면 (글꼴/다크모드)
